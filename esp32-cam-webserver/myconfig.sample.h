...
// Default Page: uncomment to make the "Robot Control" interface the default
// #define DEFAULT_INDEX_PROJECT

/*
 * Firebase (optional)
 *
 * Provide your Firebase credentials to push captured still images to the Realtime Database.
 * If left undefined the firmware skips the upload step.
 */
// #define FIREBASE_API_KEY "AIza..."
// #define FIREBASE_DATABASE_URL "https://your-project-id-default-rtdb.firebaseio.com"
// Optional: authenticate with an email/password user instead of anonymous sign-in
// #define FIREBASE_USER_EMAIL "user@example.com"
// #define FIREBASE_USER_PASSWORD "yourStrongPassword"
// Optional: override the root node (default "/captures")
// #define FIREBASE_ROOT_NODE "/captures"
// Optional: override the collection name used while in AP mode
// #define FIREBASE_AP_LABEL "microscopio_05"
